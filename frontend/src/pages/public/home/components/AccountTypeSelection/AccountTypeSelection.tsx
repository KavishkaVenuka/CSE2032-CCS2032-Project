...
import { GraduationCap, Building, Check, UserCheck, Briefcase } from 'lucide-react';
...
const AccountTypeSelection = () => {
  ...
  const accountTypes = [
    {
      ...
      description: 'Perfect for students, fresh graduates, and professionals looking for new opportunities',
      features: [
    ...
    },
    {
      ...
      description: 'Ideal for companies, startups, and organizations looking to hire talented professionals',
      features: [
  ...
  const handleCardClick = (typeId) => {
    ...
    const card = document.querySelector(`[data-card="${typeId}"]`);
    if (card) {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            const cards = entry.target.querySelectorAll('.account-card');
