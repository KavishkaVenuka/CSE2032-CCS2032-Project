  ...
  const steps = [
    {
      ...
      description: 'Create your free CareerLink account as a Student, Company just a few clicks to unlock exclusive access to a world of job opportunities and landing your dream job. It\'s quick, easy, and completely free.'
    },
    {
      id: 2,
      number: '02',
      ...
      description: 'Add your details, interests, and goals to stand out. For companies, showcase your brand and job offerings. A complete profile increases visibility and trust.'
    },
    {
      id: 3,
      number: '03',
      ...
      description: 'Students can explore internships, part-time, and full-time jobs. Companies and career units can post exciting openings. The platform keeps everything organized and easy to access.'
    },
    {
      id: 4,
      number: '04',
      ...
      description: 'Apply, communicate, and take the next step in your career. Companies can review applicants and schedule interviews. Build meaningful connections and launch your future.'
    }
  ];
