  ...
  const features = [
    {
      ...
      description: 'Join thousands of professionals who trust us with their career journey'
    },
    {
      icon: Building,
      title: '2,500+ Partner Companies', 
      description: 'From startups to Fortune 500 companies, we work with the best'
    },
    {
      icon: TrendingUp,
      title: '95% Success Rate',
      description: 'Our users find their dream jobs faster than anywhere else'
    }
  ];
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting && !hasAnimated) {
            ...
            // Animate content
            const textContent = entry.target.querySelector('.about-text');
            const imageContent = entry.target.querySelector('.about-image');
